...
# 历史数据地址
hist_data_path = r'S:\Users\lishechuan\python\coincock\data\全量股票数据'  # 换成自己电脑的地址
dingding_robot_id = 'c2d937d6c119b20f4d71c34a714d8bd2a082783133a44dd1cda0800c579f83d3'  # 换成自己的钉钉id
...
def main():
    ...
    #     if_trade = True
    # # sleep直至需要运行的时间附近
    # time.sleep(m  ax(0, (run_time - datetime.now()).seconds))
    # while True:  # 在靠近目标时间时
    ...
    if sell_stock:
        ...
        # sell_amount = 100
        order_info = ths.sell(stock_info['交易代码'], '%.2f' % order_price, '%s' % int(sell_amount))
