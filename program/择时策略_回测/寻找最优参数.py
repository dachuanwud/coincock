...
from Signals import simple_moving_average_signal, simple_moving_average_para_list
...
# 读入股票数据
stock_code = 'sz000002'
df = pd.read_csv('/Users/lishechuan/python/coincock/data/择时策略-回测/%s.csv' % stock_code,
...
for para in para_list:
    ...
    temp_df = temp_df[temp_df['交易日期'] <= pd.to_datetime('20190409')]
    # 计算资金曲线
