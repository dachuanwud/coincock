...
date_end = '2021-10-03'  # 回测结束时间

# ===读取所有股票代码的列表
path = '/Users/lishechuan/python/coincock/data/选股策略/xbx_stock_day_data/stock'
...
# 将数据存储到hdf文件
all_stock_data.to_hdf('/Users/lishechuan/python/coincock/data/选股策略/all_stock_data_'+period_type+'.h5', 'df', mode='w')
